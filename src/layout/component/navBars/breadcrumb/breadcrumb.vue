<template>
    <div class="layout-navbars-breadcrumb" v-show="getThemeConfig.isBreadcrumb">
        ...
        <div class="layout-navbars-breadcrumb-right">
            ...
            >
                <div>
                    <svg-icon icon-class="threeDimesion" @click="to3dVisual" />
                </div>
            </el-tooltip>
            <el-image
                style="
            ...
            <el-dropdown>
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        ...
                        <el-dropdown-item divided @click="ountlogin">
                            退出登录
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </template>
...
<script setup lang="ts">
    ...
    const initRouteSplit = (path: string) => {
        const permissionRouteList = permissionStore.routeList
        if (!configStore.config.isBreadcrumb) return false
